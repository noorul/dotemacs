...
#+BEGIN_SRC emacs-lisp
  (custom-set-variables
'(org-agenda-files (quote ("~/ownCloud/orgfiles/")))
'(org-default-notes-file (concat org-directory "/notes.org"))
'(org-directory "~/ownCloud/orgfiles")
...
(global-set-key (kbd "\e\ei")
		(lambda () (interactive) (find-file "~/ownCloud/orgfiles/i.org")))

(global-set-key (kbd "\e\ea")
		(lambda () (interactive) (find-file "~/ownCloud/orgfiles/apcs.org")))

(global-set-key (kbd "\e\es")
		(lambda () (interactive) (find-file "~/ownCloud/orgfiles/softdev.org")))
(global-set-key (kbd "\e\ec")
		(lambda () (interactive) (find-file "~/ownCloud/orgfiles/cstuy.org")))
