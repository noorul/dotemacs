...
** Haskell
#+begin_src emacs-lisp
(sacha/package-install 'ac-haskell-process)
(sacha/package-install 'flycheck-haskell)
(sacha/package-install 'haskell-mode)
(sacha/package-install 'hi2)
(sacha/package-install 'ghc)
