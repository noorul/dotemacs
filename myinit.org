  ...
  (setq org-capture-templates
        '(("a" "Appointment" entry (file+headline  "~/cloud/orgfiles/schedule.org" "Appointments")
          ...
          ("n" "Note" entry (file+headline "~/cloud/orgfiles/notes.org" "Notes")
           "* Note %?\n%T")
           ("l" "Link" entry (file+headline "~/cloud/orgfiles/links.org" "Links")
           "* %? %^L\n%T" :prepend t)
          ("b" "Blog idea" entry (file+headline "~/cloud/orgfiles/i.org" "Blog Topics")
           "* %?\n%T" :prepend t)
...
(global-set-key (kbd "\e\eb")
		(lambda () (interactive) (find-file "~/cloud/orgfiles/links.org")))
